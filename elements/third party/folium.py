...
def run():
    ...
    st.write('Here is an example of a map with geojson data (you need to identify a geojson data source [here is one for France](https://github.com/gregoiredavid/france-geojson)')
