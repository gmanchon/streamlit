...
def run():
    ...
    with st.echo():
        # this defines the location where the placeholder will be displayed
        placeholder = st.empty()

        # this should be displayed after, according to its position in the code,
        # but gets displayed before
